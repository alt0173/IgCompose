...
namespace fpf_node {
	...
	template <class element>
	void list_insert_head(const typename node<element>::data_type& d_new_data, typename node<element>::node_type& nt_ion_head_ptr, typename node<element>::node_type& nt_ion_tail_ptr) {
		node<element>::node_type nt_new_ptr = new node;
		nt_new_ptr->set_data_d(d_new_data);
		if (nt_ion_head_ptr == NULL) {
			nt_ion_head_ptr = nt_new_ptr;
		}
		if (nt_ion_tail_ptr == NULL) {
			nt_ion_tail_ptr = nt_new_ptr;
		}
		nt_new_ptr->set_up_node_nt(nt_ion_head_ptr);
		nt_ion_head_ptr->set_down_node_nt(nt_new_ptr);
		nt_ion_head_ptr = nt_ion_head_ptr->return_down_node_nt();
	};
	//
	//

	template <class element>
	void list_insert_tail(const typename node<element>::data_type& d_new_data, typename node<element>::node_type& nt_ion_head_ptr, typename node<element>::node_type& nt_ion_tail_ptr) {
		...
		nt_new_ptr->set_down_node_nt(nt_ion_tail_ptr);
		nt_ion_tail_ptr->set_up_node_nt(nt_new_ptr);
		nt_ion_tail_ptr = nt_ion_tail_ptr->return_up_node_nt();
	};
	//
	//

	template <class element>
	void list_insert_up(const typename node<element>::data_type& d_new_data, typename node<element>::node_type& nt_current_ptr, typename node<element>::node_type& nt_ion_head_ptr, typename node<element>::node_type& nt_ion_tail_ptr) {
		if (nt_current_ptr != nt_ion_tail_ptr) {
			node<element>::node_type nt_new_ptr = new node<element>;
			nt_new_ptr->set_data_d(d_new_data);
			...
			list_insert_tail<element>(d_new_data, nt_ion_head_ptr, nt_ion_tail_ptr);
		}
	};
	//
	//
	...
	void list_remove_head(typename node<element>::node_type& nt_ion_head_ptr) {
		...
		nt_ion_head_ptr = nt_del_ptr->return_up_node_nt();
